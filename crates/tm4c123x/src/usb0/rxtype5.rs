#[doc = "Reader of register RXTYPE5"]
pub type R = crate::R<u8, super::RXTYPE5>;
#[doc = "Writer for register RXTYPE5"]
pub type W = crate::W<u8, super::RXTYPE5>;
#[doc = "Register RXTYPE5 `reset()`'s with value 0"]
impl crate::ResetValue for super::RXTYPE5 {
    type Type = u8;
    #[inline(always)]
