#[doc = "Reader of register TXTYPE6"]
pub type R = crate::R<u8, super::TXTYPE6>;
#[doc = "Writer for register TXTYPE6"]
pub type W = crate::W<u8, super::TXTYPE6>;
#[doc = "Register TXTYPE6 `reset()`'s with value 0"]
impl crate::ResetValue for super::TXTYPE6 {
    type Type = u8;
    #[inline(always)]
