#[doc = "Reader of register TXCSRH1"]
pub type R = crate::R<u8, super::TXCSRH1>;
#[doc = "Writer for register TXCSRH1"]
pub type W = crate::W<u8, super::TXCSRH1>;
#[doc = "Register TXCSRH1 `reset()`'s with value 0"]
impl crate::ResetValue for super::TXCSRH1 {
    type Type = u8;
    #[inline(always)]
