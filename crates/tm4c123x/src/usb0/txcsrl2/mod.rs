...
impl W {
    ...
    #[doc = "Bit 1 - FIFO Not Empty"]
    #[inline]
    pub fn fifone(&mut self) -> _FIFONEW {
        _FIFONEW { w: self }
    }
    #[doc = "Bit 2 - Error"]
    #[inline]
