#[doc = "Reader of register RXTYPE3"]
pub type R = crate::R<u8, super::RXTYPE3>;
#[doc = "Writer for register RXTYPE3"]
pub type W = crate::W<u8, super::RXTYPE3>;
#[doc = "Register RXTYPE3 `reset()`'s with value 0"]
impl crate::ResetValue for super::RXTYPE3 {
    type Type = u8;
    #[inline(always)]
