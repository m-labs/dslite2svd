#[doc = "Reader of register TXCSRL2"]
pub type R = crate::R<u8, super::TXCSRL2>;
#[doc = "Writer for register TXCSRL2"]
pub type W = crate::W<u8, super::TXCSRL2>;
#[doc = "Register TXCSRL2 `reset()`'s with value 0"]
impl crate::ResetValue for super::TXCSRL2 {
    type Type = u8;
    #[inline(always)]
