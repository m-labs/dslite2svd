#[doc = "Reader of register TXCSRL4"]
pub type R = crate::R<u8, super::TXCSRL4>;
#[doc = "Writer for register TXCSRL4"]
pub type W = crate::W<u8, super::TXCSRL4>;
#[doc = "Register TXCSRL4 `reset()`'s with value 0"]
impl crate::ResetValue for super::TXCSRL4 {
    type Type = u8;
    #[inline(always)]
