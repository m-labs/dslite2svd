#[doc = "Reader of register TXCSRL6"]
pub type R = crate::R<u8, super::TXCSRL6>;
#[doc = "Writer for register TXCSRL6"]
pub type W = crate::W<u8, super::TXCSRL6>;
#[doc = "Register TXCSRL6 `reset()`'s with value 0"]
impl crate::ResetValue for super::TXCSRL6 {
    type Type = u8;
    #[inline(always)]
