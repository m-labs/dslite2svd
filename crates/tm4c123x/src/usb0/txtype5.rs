#[doc = "Reader of register TXTYPE5"]
pub type R = crate::R<u8, super::TXTYPE5>;
#[doc = "Writer for register TXTYPE5"]
pub type W = crate::W<u8, super::TXTYPE5>;
#[doc = "Register TXTYPE5 `reset()`'s with value 0"]
impl crate::ResetValue for super::TXTYPE5 {
    type Type = u8;
    #[inline(always)]
