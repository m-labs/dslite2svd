#[doc = "Reader of register TXMAXP7"]
pub type R = crate::R<u16, super::TXMAXP7>;
#[doc = "Writer for register TXMAXP7"]
pub type W = crate::W<u16, super::TXMAXP7>;
#[doc = "Register TXMAXP7 `reset()`'s with value 0"]
impl crate::ResetValue for super::TXMAXP7 {
    type Type = u16;
    #[inline(always)]
