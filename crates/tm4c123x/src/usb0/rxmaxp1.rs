#[doc = "Reader of register RXMAXP1"]
pub type R = crate::R<u16, super::RXMAXP1>;
#[doc = "Writer for register RXMAXP1"]
pub type W = crate::W<u16, super::RXMAXP1>;
#[doc = "Register RXMAXP1 `reset()`'s with value 0"]
impl crate::ResetValue for super::RXMAXP1 {
    type Type = u16;
    #[inline(always)]
