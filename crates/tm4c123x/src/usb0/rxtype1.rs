#[doc = "Reader of register RXTYPE1"]
pub type R = crate::R<u8, super::RXTYPE1>;
#[doc = "Writer for register RXTYPE1"]
pub type W = crate::W<u8, super::RXTYPE1>;
#[doc = "Register RXTYPE1 `reset()`'s with value 0"]
impl crate::ResetValue for super::RXTYPE1 {
    type Type = u8;
    #[inline(always)]
