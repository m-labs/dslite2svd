#[doc = "Reader of register TXFIFOSZ"]
pub type R = crate::R<u8, super::TXFIFOSZ>;
#[doc = "Writer for register TXFIFOSZ"]
pub type W = crate::W<u8, super::TXFIFOSZ>;
#[doc = "Register TXFIFOSZ `reset()`'s with value 0"]
impl crate::ResetValue for super::TXFIFOSZ {
    type Type = u8;
    #[inline(always)]
