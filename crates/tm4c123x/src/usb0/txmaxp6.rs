#[doc = "Reader of register TXMAXP6"]
pub type R = crate::R<u16, super::TXMAXP6>;
#[doc = "Writer for register TXMAXP6"]
pub type W = crate::W<u16, super::TXMAXP6>;
#[doc = "Register TXMAXP6 `reset()`'s with value 0"]
impl crate::ResetValue for super::TXMAXP6 {
    type Type = u16;
    #[inline(always)]
