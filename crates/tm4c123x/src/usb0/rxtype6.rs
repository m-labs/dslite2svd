#[doc = "Reader of register RXTYPE6"]
pub type R = crate::R<u8, super::RXTYPE6>;
#[doc = "Writer for register RXTYPE6"]
pub type W = crate::W<u8, super::RXTYPE6>;
#[doc = "Register RXTYPE6 `reset()`'s with value 0"]
impl crate::ResetValue for super::RXTYPE6 {
    type Type = u8;
    #[inline(always)]
