#[doc = "Reader of register RXTYPE7"]
pub type R = crate::R<u8, super::RXTYPE7>;
#[doc = "Writer for register RXTYPE7"]
pub type W = crate::W<u8, super::RXTYPE7>;
#[doc = "Register RXTYPE7 `reset()`'s with value 0"]
impl crate::ResetValue for super::RXTYPE7 {
    type Type = u8;
    #[inline(always)]
