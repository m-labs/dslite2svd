#[doc = "Reader of register TXMAXP2"]
pub type R = crate::R<u16, super::TXMAXP2>;
#[doc = "Writer for register TXMAXP2"]
pub type W = crate::W<u16, super::TXMAXP2>;
#[doc = "Register TXMAXP2 `reset()`'s with value 0"]
impl crate::ResetValue for super::TXMAXP2 {
    type Type = u16;
    #[inline(always)]
