#[doc = "Reader of register TXCSRH3"]
pub type R = crate::R<u8, super::TXCSRH3>;
#[doc = "Writer for register TXCSRH3"]
pub type W = crate::W<u8, super::TXCSRH3>;
#[doc = "Register TXCSRH3 `reset()`'s with value 0"]
impl crate::ResetValue for super::TXCSRH3 {
    type Type = u8;
    #[inline(always)]
