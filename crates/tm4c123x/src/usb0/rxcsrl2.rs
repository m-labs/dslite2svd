#[doc = "Reader of register RXCSRL2"]
pub type R = crate::R<u8, super::RXCSRL2>;
#[doc = "Writer for register RXCSRL2"]
pub type W = crate::W<u8, super::RXCSRL2>;
#[doc = "Register RXCSRL2 `reset()`'s with value 0"]
impl crate::ResetValue for super::RXCSRL2 {
    type Type = u8;
    #[inline(always)]
