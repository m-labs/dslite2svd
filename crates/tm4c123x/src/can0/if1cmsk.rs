#[doc = "Reader of register IF1CMSK"]
pub type R = crate::R<u32, super::IF1CMSK>;
#[doc = "Writer for register IF1CMSK"]
pub type W = crate::W<u32, super::IF1CMSK>;
#[doc = "Register IF1CMSK `reset()`'s with value 0"]
impl crate::ResetValue for super::IF1CMSK {
    type Type = u32;
    #[inline(always)]
