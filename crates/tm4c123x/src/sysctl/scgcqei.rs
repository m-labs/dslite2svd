#[doc = "Reader of register SCGCQEI"]
pub type R = crate::R<u32, super::SCGCQEI>;
#[doc = "Writer for register SCGCQEI"]
pub type W = crate::W<u32, super::SCGCQEI>;
#[doc = "Register SCGCQEI `reset()`'s with value 0"]
impl crate::ResetValue for super::SCGCQEI {
    type Type = u32;
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bit 1 - QEI Module 1 Sleep Mode Clock Gating Control"]
    #[inline(always)]
    pub fn s1(&self) -> S1_R {
