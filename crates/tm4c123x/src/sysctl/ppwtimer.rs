...
impl R {
    ...
    #[doc = "Bit 1 - 32/64-Bit Wide General-Purpose Timer 1 Present"]
    #[inline(always)]
    pub fn p1(&self) -> P1_R {
        P1_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 2 - 32/64-Bit Wide General-Purpose Timer 2 Present"]
    #[inline(always)]
    pub fn p2(&self) -> P2_R {
        P2_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 3 - 32/64-Bit Wide General-Purpose Timer 3 Present"]
    #[inline(always)]
    pub fn p3(&self) -> P3_R {
        P3_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 4 - 32/64-Bit Wide General-Purpose Timer 4 Present"]
    #[inline(always)]
    pub fn p4(&self) -> P4_R {
        P4_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 5 - 32/64-Bit Wide General-Purpose Timer 5 Present"]
    #[inline(always)]
    pub fn p5(&self) -> P5_R {
