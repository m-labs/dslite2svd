#[doc = "Reader of register SCGCADC"]
pub type R = crate::R<u32, super::SCGCADC>;
#[doc = "Writer for register SCGCADC"]
pub type W = crate::W<u32, super::SCGCADC>;
#[doc = "Register SCGCADC `reset()`'s with value 0"]
impl crate::ResetValue for super::SCGCADC {
    type Type = u32;
    #[inline(always)]
