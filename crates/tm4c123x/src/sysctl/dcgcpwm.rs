#[doc = "Reader of register DCGCPWM"]
pub type R = crate::R<u32, super::DCGCPWM>;
#[doc = "Writer for register DCGCPWM"]
pub type W = crate::W<u32, super::DCGCPWM>;
#[doc = "Register DCGCPWM `reset()`'s with value 0"]
impl crate::ResetValue for super::DCGCPWM {
    type Type = u32;
    #[inline(always)]
