#[doc = "Reader of register SCGCWTIMER"]
pub type R = crate::R<u32, super::SCGCWTIMER>;
#[doc = "Writer for register SCGCWTIMER"]
pub type W = crate::W<u32, super::SCGCWTIMER>;
#[doc = "Register SCGCWTIMER `reset()`'s with value 0"]
impl crate::ResetValue for super::SCGCWTIMER {
    type Type = u32;
    #[inline(always)]
...
impl R {
    #[doc = "Bit 0 - 32/64-Bit Wide General-Purpose Timer 0 Sleep Mode Clock Gating Control"]
    #[inline(always)]
    pub fn s0(&self) -> S0_R {
        S0_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - 32/64-Bit Wide General-Purpose Timer 1 Sleep Mode Clock Gating Control"]
    #[inline(always)]
    pub fn s1(&self) -> S1_R {
        S1_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 2 - 32/64-Bit Wide General-Purpose Timer 2 Sleep Mode Clock Gating Control"]
    #[inline(always)]
    pub fn s2(&self) -> S2_R {
        S2_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 3 - 32/64-Bit Wide General-Purpose Timer 3 Sleep Mode Clock Gating Control"]
    #[inline(always)]
    pub fn s3(&self) -> S3_R {
        S3_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 4 - 32/64-Bit Wide General-Purpose Timer 4 Sleep Mode Clock Gating Control"]
    #[inline(always)]
    pub fn s4(&self) -> S4_R {
        S4_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 5 - 32/64-Bit Wide General-Purpose Timer 5 Sleep Mode Clock Gating Control"]
    #[inline(always)]
    pub fn s5(&self) -> S5_R {
