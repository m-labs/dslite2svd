#[doc = "Reader of register RCGCCAN"]
pub type R = crate::R<u32, super::RCGCCAN>;
#[doc = "Writer for register RCGCCAN"]
pub type W = crate::W<u32, super::RCGCCAN>;
#[doc = "Register RCGCCAN `reset()`'s with value 0"]
impl crate::ResetValue for super::RCGCCAN {
    type Type = u32;
    #[inline(always)]
