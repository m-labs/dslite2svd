#[doc = "Reader of register DCCTL0"]
pub type R = crate::R<u32, super::DCCTL0>;
#[doc = "Writer for register DCCTL0"]
pub type W = crate::W<u32, super::DCCTL0>;
#[doc = "Register DCCTL0 `reset()`'s with value 0"]
impl crate::ResetValue for super::DCCTL0 {
    type Type = u32;
    #[inline(always)]
