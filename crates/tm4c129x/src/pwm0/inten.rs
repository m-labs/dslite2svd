...
#[doc = "Reader of field `INTFAULT2`"]
pub type INTFAULT2_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `INTFAULT2`"]
pub struct INTFAULT2_W<'a> {
    w: &'a mut W,
}
impl<'a> INTFAULT2_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Reader of field `INTFAULT3`"]
pub type INTFAULT3_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `INTFAULT3`"]
pub struct INTFAULT3_W<'a> {
    w: &'a mut W,
}
impl<'a> INTFAULT3_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    #[inline(always)]
    pub fn intfault2(&self) -> INTFAULT2_R {
        INTFAULT2_R::new(((self.bits >> 18) & 0x01) != 0)
    }
    #[doc = "Bit 19 - Interrupt Fault 3"]
    #[inline(always)]
    pub fn intfault3(&self) -> INTFAULT3_R {
        INTFAULT3_R::new(((self.bits >> 19) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - PWM0 Interrupt Enable"]
    ...
    #[doc = "Bit 18 - Interrupt Fault 2"]
    #[inline(always)]
    pub fn intfault2(&mut self) -> INTFAULT2_W {
        INTFAULT2_W { w: self }
    }
    #[doc = "Bit 19 - Interrupt Fault 3"]
    #[inline(always)]
    pub fn intfault3(&mut self) -> INTFAULT3_W {
        INTFAULT3_W { w: self }
    }
}
