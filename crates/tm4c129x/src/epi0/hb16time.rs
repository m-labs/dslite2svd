#[doc = "Reader of register HB16TIME"]
pub type R = crate::R<u32, super::HB16TIME>;
#[doc = "Writer for register HB16TIME"]
pub type W = crate::W<u32, super::HB16TIME>;
#[doc = "Register HB16TIME `reset()`'s with value 0"]
impl crate::ResetValue for super::HB16TIME {
    type Type = u32;
    #[inline(always)]
