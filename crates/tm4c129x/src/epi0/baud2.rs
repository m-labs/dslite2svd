#[doc = "Reader of register BAUD2"]
pub type R = crate::R<u32, super::BAUD2>;
#[doc = "Writer for register BAUD2"]
pub type W = crate::W<u32, super::BAUD2>;
#[doc = "Register BAUD2 `reset()`'s with value 0"]
impl crate::ResetValue for super::BAUD2 {
    type Type = u32;
    #[inline(always)]
