...
#[doc = "Possible values of the field `CSCFG`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum CSCFGR {
...
#[doc = "Values that can be written to the field `CSCFG`"]
pub enum CSCFGW {
    #[doc = "ALE Configuration"]
    ALE,
    #[doc = "CSn Configuration"]
...
#[doc = r" Proxy"]
pub struct _CSCFGW<'a> {
    w: &'a mut W,
}
impl<'a> _CSCFGW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: CSCFGW) -> &'a mut W {
        {
            self.bits(variant._bits())
        }
    }
    ...
    pub fn ale(self) -> &'a mut W {
        self.variant(CSCFGW::ALE)
    }
    #[doc = "CSn Configuration"]
    #[inline]
    pub fn cs(self) -> &'a mut W {
        self.variant(CSCFGW::CS)
    }
    #[doc = "Dual CSn Configuration"]
    #[inline]
    pub fn dcs(self) -> &'a mut W {
        self.variant(CSCFGW::DCS)
    }
    #[doc = "ALE with Dual CSn Configuration"]
    #[inline]
    pub fn adcs(self) -> &'a mut W {
        self.variant(CSCFGW::ADCS)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub fn bits(self, value: u8) -> &'a mut W {
...
impl R {
    ...
    #[inline]
    pub fn cscfgext(&self) -> CSCFGEXTR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 27;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 17 - CS1n PSRAM Configuration Register Read"]
    #[inline]
    pub fn rdcre(&mut self) -> _RDCREW {
        _RDCREW { w: self }
    }
    #[doc = "Bit 18 - CS1n PSRAM Configuration Register Write"]
    #[inline]
    pub fn wrcre(&mut self) -> _WRCREW {
        _WRCREW { w: self }
    }
    #[doc = "Bit 19 - CS1n ALE Strobe Polarity"]
    #[inline]
    ...
    #[doc = "Bits 24:25 - Chip Select Configuration"]
    #[inline]
    pub fn cscfg(&mut self) -> _CSCFGW {
        _CSCFGW { w: self }
    }
    #[doc = "Bit 26 - Chip Select Baud Rate and Multiple Sub-Mode Configuration enable"]
    #[inline]
    pub fn csbaud(&mut self) -> _CSBAUDW {
        _CSBAUDW { w: self }
    }
    #[doc = "Bit 27 - Chip Select Extended Configuration"]
    #[inline]
    pub fn cscfgext(&mut self) -> _CSCFGEXTW {
        _CSCFGEXTW { w: self }
    }
}
