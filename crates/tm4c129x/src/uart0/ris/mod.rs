...
impl R {
    ...
    #[inline]
    pub fn _9bitris(&self) -> _9BITRISR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 12;
            ((self.bits >> OFFSET) & MASK as u32) != 0
