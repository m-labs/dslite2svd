...
#[doc = "Reader of field `RIMIS`"]
pub type RIMIS_R = crate::R<bool, bool>;
#[doc = "Reader of field `CTSMIS`"]
pub type CTSMIS_R = crate::R<bool, bool>;
#[doc = "Reader of field `DCDMIS`"]
pub type DCDMIS_R = crate::R<bool, bool>;
#[doc = "Reader of field `DSRMIS`"]
pub type DSRMIS_R = crate::R<bool, bool>;
...
impl R {
    ...
    #[inline(always)]
    pub fn rimis(&self) -> RIMIS_R {
        RIMIS_R::new((self.bits & 0x01) != 0)
    }
    ...
    #[inline(always)]
    pub fn dcdmis(&self) -> DCDMIS_R {
        DCDMIS_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 3 - UART Data Set Ready Modem Masked Interrupt Status"]
    #[inline(always)]
    pub fn dsrmis(&self) -> DSRMIS_R {
        DSRMIS_R::new(((self.bits >> 3) & 0x01) != 0)
    }
