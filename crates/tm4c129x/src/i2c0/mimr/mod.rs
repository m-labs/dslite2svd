...
#[doc = r" Proxy"]
pub struct _ARBLOSTIMW<'a> {
    w: &'a mut W,
}
impl<'a> _ARBLOSTIMW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl R {
    ...
    #[inline]
    pub fn arblostim(&self) -> ARBLOSTIMR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 7;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 2 - Receive DMA Interrupt Mask"]
    #[inline]
    pub fn dmarxim(&mut self) -> _DMARXIMW {
        _DMARXIMW { w: self }
    }
    #[doc = "Bit 3 - Transmit DMA Interrupt Mask"]
    #[inline]
    pub fn dmatxim(&mut self) -> _DMATXIMW {
        _DMATXIMW { w: self }
    }
    #[doc = "Bit 4 - Address/Data NACK Interrupt Mask"]
    #[inline]
    pub fn nackim(&mut self) -> _NACKIMW {
        _NACKIMW { w: self }
    }
    #[doc = "Bit 5 - START Detection Interrupt Mask"]
    #[inline]
    ...
    #[doc = "Bit 7 - Arbitration Lost Interrupt Mask"]
    #[inline]
    pub fn arblostim(&mut self) -> _ARBLOSTIMW {
        _ARBLOSTIMW { w: self }
    }
    #[doc = "Bit 8 - Transmit FIFO Request Interrupt Mask"]
    #[inline]
    ...
    #[doc = "Bit 11 - Receive FIFO Full Interrupt Mask"]
    #[inline]
    pub fn rxffim(&mut self) -> _RXFFIMW {
        _RXFFIMW { w: self }
    }
}
