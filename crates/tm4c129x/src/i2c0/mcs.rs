...
#[doc = "Reader of field `QCMD`"]
pub type QCMD_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `QCMD`"]
pub struct QCMD_W<'a> {
    w: &'a mut W,
}
impl<'a> QCMD_W<'a> {
...
impl R {
    ...
    #[inline(always)]
    pub fn qcmd(&self) -> QCMD_R {
        QCMD_R::new(((self.bits >> 5) & 0x01) != 0)
    }
    #[doc = "Bit 6 - Burst Enable"]
    #[inline(always)]
    pub fn burst(&self) -> BURST_R {
        BURST_R::new(((self.bits >> 6) & 0x01) != 0)
    }
    #[doc = "Bit 6 - Bus Busy"]
    #[inline(always)]
