...
impl R {
    ...
    #[inline]
    pub fn actdmatx(&self) -> ACTDMATXR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 30;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
    pub fn actdmarx(&self) -> ACTDMARXR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 31;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 2 - Acknowledge Address"]
    #[inline]
    pub fn adrack(&mut self) -> _ADRACKW {
        _ADRACKW { w: self }
    }
    #[doc = "Bit 2 - Generate STOP"]
    #[inline]
    ...
    #[doc = "Bit 3 - Acknowledge Data"]
    #[inline]
    pub fn datack(&mut self) -> _DATACKW {
        _DATACKW { w: self }
    }
    #[doc = "Bit 4 - Arbitration Lost"]
    #[inline]
    ...
    #[doc = "Bit 7 - Clock Timeout Error"]
    #[inline]
    pub fn clkto(&mut self) -> _CLKTOW {
        _CLKTOW { w: self }
    }
    #[doc = "Bit 30 - DMA TX Active Status"]
    #[inline]
    pub fn actdmatx(&mut self) -> _ACTDMATXW {
        _ACTDMATXW { w: self }
    }
    #[doc = "Bit 31 - DMA RX Active Status"]
    #[inline]
    pub fn actdmarx(&mut self) -> _ACTDMARXW {
        _ACTDMARXW { w: self }
    }
}
