...
#[doc = r" Proxy"]
pub struct _ARBLOSTICW<'a> {
    w: &'a mut W,
}
impl<'a> _ARBLOSTICW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[inline]
    pub fn nackic(&mut self) -> _NACKICW {
        _NACKICW { w: self }
    }
    ...
    #[inline]
    pub fn arblostic(&mut self) -> _ARBLOSTICW {
        _ARBLOSTICW { w: self }
    }
