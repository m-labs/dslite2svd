...
impl W {
    ...
    #[inline]
    pub fn dmarxic(&mut self) -> _DMARXICW {
        _DMARXICW { w: self }
    }
    #[doc = "Bit 4 - Transmit DMA Interrupt Clear"]
    #[inline]
    pub fn dmatxic(&mut self) -> _DMATXICW {
        _DMATXICW { w: self }
    }
    ...
    #[inline]
    pub fn rxffic(&mut self) -> _RXFFICW {
        _RXFFICW { w: self }
    }
}
