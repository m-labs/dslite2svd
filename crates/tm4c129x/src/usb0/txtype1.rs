#[doc = "Reader of register TXTYPE1"]
pub type R = crate::R<u8, super::TXTYPE1>;
#[doc = "Writer for register TXTYPE1"]
pub type W = crate::W<u8, super::TXTYPE1>;
#[doc = "Register TXTYPE1 `reset()`'s with value 0"]
impl crate::ResetValue for super::TXTYPE1 {
    type Type = u8;
    #[inline(always)]
