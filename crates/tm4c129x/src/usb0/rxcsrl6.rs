#[doc = "Reader of register RXCSRL6"]
pub type R = crate::R<u8, super::RXCSRL6>;
#[doc = "Writer for register RXCSRL6"]
pub type W = crate::W<u8, super::RXCSRL6>;
#[doc = "Register RXCSRL6 `reset()`'s with value 0"]
impl crate::ResetValue for super::RXCSRL6 {
    type Type = u8;
    #[inline(always)]
