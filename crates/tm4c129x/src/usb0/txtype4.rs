#[doc = "Reader of register TXTYPE4"]
pub type R = crate::R<u8, super::TXTYPE4>;
#[doc = "Writer for register TXTYPE4"]
pub type W = crate::W<u8, super::TXTYPE4>;
#[doc = "Register TXTYPE4 `reset()`'s with value 0"]
impl crate::ResetValue for super::TXTYPE4 {
    type Type = u8;
    #[inline(always)]
