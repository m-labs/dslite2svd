#[doc = "Reader of register RXCSRL3"]
pub type R = crate::R<u8, super::RXCSRL3>;
#[doc = "Writer for register RXCSRL3"]
pub type W = crate::W<u8, super::RXCSRL3>;
#[doc = "Register RXCSRL3 `reset()`'s with value 0"]
impl crate::ResetValue for super::RXCSRL3 {
    type Type = u8;
    #[inline(always)]
