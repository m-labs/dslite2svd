#[doc = "Writer for register CSRL0"]
pub type W = crate::W<u8, super::CSRL0>;
#[doc = "Register CSRL0 `reset()`'s with value 0"]
impl crate::ResetValue for super::CSRL0 {
    type Type = u8;
    #[inline(always)]
...
#[doc = "Write proxy for field `DATAEND`"]
pub struct DATAEND_W<'a> {
    w: &'a mut W,
}
impl<'a> DATAEND_W<'a> {
    #[doc = r"Sets the field bit"]
...
#[doc = "Write proxy for field `SETEND`"]
pub struct SETEND_W<'a> {
    w: &'a mut W,
}
impl<'a> SETEND_W<'a> {
    #[doc = r"Sets the field bit"]
...
#[doc = "Write proxy for field `RXRDYC`"]
pub struct RXRDYC_W<'a> {
    w: &'a mut W,
}
impl<'a> RXRDYC_W<'a> {
    #[doc = r"Sets the field bit"]
...
#[doc = "Write proxy for field `SETENDC`"]
pub struct SETENDC_W<'a> {
    w: &'a mut W,
}
impl<'a> SETENDC_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl W {
    ...
    #[doc = "Bit 3 - Data End"]
    #[inline(always)]
    pub fn dataend(&mut self) -> DATAEND_W {
        DATAEND_W { w: self }
    }
    ...
    #[doc = "Bit 4 - Setup End"]
    #[inline(always)]
    pub fn setend(&mut self) -> SETEND_W {
        SETEND_W { w: self }
    }
    #[doc = "Bit 4 - Error"]
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn rxrdyc(&mut self) -> RXRDYC_W {
        RXRDYC_W { w: self }
    }
    ...
    #[inline(always)]
    pub fn setendc(&mut self) -> SETENDC_W {
        SETENDC_W { w: self }
    }
}
