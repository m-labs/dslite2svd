#[doc = "Reader of register TXMAXP4"]
pub type R = crate::R<u16, super::TXMAXP4>;
#[doc = "Writer for register TXMAXP4"]
pub type W = crate::W<u16, super::TXMAXP4>;
#[doc = "Register TXMAXP4 `reset()`'s with value 0"]
impl crate::ResetValue for super::TXMAXP4 {
    type Type = u16;
    #[inline(always)]
