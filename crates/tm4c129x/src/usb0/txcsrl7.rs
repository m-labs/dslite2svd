#[doc = "Reader of register TXCSRL7"]
pub type R = crate::R<u8, super::TXCSRL7>;
#[doc = "Writer for register TXCSRL7"]
pub type W = crate::W<u8, super::TXCSRL7>;
#[doc = "Register TXCSRL7 `reset()`'s with value 0"]
impl crate::ResetValue for super::TXCSRL7 {
    type Type = u8;
    #[inline(always)]
