#[doc = "Reader of register RXCSRL4"]
pub type R = crate::R<u8, super::RXCSRL4>;
#[doc = "Writer for register RXCSRL4"]
pub type W = crate::W<u8, super::RXCSRL4>;
#[doc = "Register RXCSRL4 `reset()`'s with value 0"]
impl crate::ResetValue for super::RXCSRL4 {
    type Type = u8;
    #[inline(always)]
