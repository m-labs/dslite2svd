#[doc = "Reader of register RXCSRH6"]
pub type R = crate::R<u8, super::RXCSRH6>;
#[doc = "Writer for register RXCSRH6"]
pub type W = crate::W<u8, super::RXCSRH6>;
#[doc = "Register RXCSRH6 `reset()`'s with value 0"]
impl crate::ResetValue for super::RXCSRH6 {
    type Type = u8;
    #[inline(always)]
...
#[doc = "Write proxy for field `INCOMPRX`"]
pub struct INCOMPRX_W<'a> {
    w: &'a mut W,
}
impl<'a> INCOMPRX_W<'a> {
...
impl W {
    #[doc = "Bit 0 - Incomplete RX Transmission Status"]
    #[inline(always)]
    pub fn incomprx(&mut self) -> INCOMPRX_W {
        INCOMPRX_W { w: self }
    }
    #[doc = "Bit 1 - Data Toggle"]
    #[inline(always)]
