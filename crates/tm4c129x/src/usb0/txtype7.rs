#[doc = "Reader of register TXTYPE7"]
pub type R = crate::R<u8, super::TXTYPE7>;
#[doc = "Writer for register TXTYPE7"]
pub type W = crate::W<u8, super::TXTYPE7>;
#[doc = "Register TXTYPE7 `reset()`'s with value 0"]
impl crate::ResetValue for super::TXTYPE7 {
    type Type = u8;
    #[inline(always)]
