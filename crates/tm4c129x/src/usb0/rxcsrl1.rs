#[doc = "Reader of register RXCSRL1"]
pub type R = crate::R<u8, super::RXCSRL1>;
#[doc = "Writer for register RXCSRL1"]
pub type W = crate::W<u8, super::RXCSRL1>;
#[doc = "Register RXCSRL1 `reset()`'s with value 0"]
impl crate::ResetValue for super::RXCSRL1 {
    type Type = u8;
    #[inline(always)]
