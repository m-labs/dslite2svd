#[doc = "Reader of register DMAINTR"]
pub type R = crate::R<u8, super::DMAINTR>;
#[doc = "Writer for register DMAINTR"]
pub type W = crate::W<u8, super::DMAINTR>;
#[doc = "Register DMAINTR `reset()`'s with value 0"]
impl crate::ResetValue for super::DMAINTR {
    type Type = u8;
    #[inline(always)]
