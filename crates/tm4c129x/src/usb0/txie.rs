#[doc = "Reader of register TXIE"]
pub type R = crate::R<u16, super::TXIE>;
#[doc = "Writer for register TXIE"]
pub type W = crate::W<u16, super::TXIE>;
#[doc = "Register TXIE `reset()`'s with value 0"]
impl crate::ResetValue for super::TXIE {
    type Type = u16;
    #[inline(always)]
