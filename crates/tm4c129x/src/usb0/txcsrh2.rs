#[doc = "Reader of register TXCSRH2"]
pub type R = crate::R<u8, super::TXCSRH2>;
#[doc = "Writer for register TXCSRH2"]
pub type W = crate::W<u8, super::TXCSRH2>;
#[doc = "Register TXCSRH2 `reset()`'s with value 0"]
impl crate::ResetValue for super::TXCSRH2 {
    type Type = u8;
    #[inline(always)]
