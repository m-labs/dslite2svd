#[doc = "Reader of register TXCSRH5"]
pub type R = crate::R<u8, super::TXCSRH5>;
#[doc = "Writer for register TXCSRH5"]
pub type W = crate::W<u8, super::TXCSRH5>;
#[doc = "Register TXCSRH5 `reset()`'s with value 0"]
impl crate::ResetValue for super::TXCSRH5 {
    type Type = u8;
    #[inline(always)]
