#[doc = "Reader of register TXMAXP5"]
pub type R = crate::R<u16, super::TXMAXP5>;
#[doc = "Writer for register TXMAXP5"]
pub type W = crate::W<u16, super::TXMAXP5>;
#[doc = "Register TXMAXP5 `reset()`'s with value 0"]
impl crate::ResetValue for super::TXMAXP5 {
    type Type = u16;
    #[inline(always)]
