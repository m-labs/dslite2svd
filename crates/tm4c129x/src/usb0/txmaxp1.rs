#[doc = "Reader of register TXMAXP1"]
pub type R = crate::R<u16, super::TXMAXP1>;
#[doc = "Writer for register TXMAXP1"]
pub type W = crate::W<u16, super::TXMAXP1>;
#[doc = "Register TXMAXP1 `reset()`'s with value 0"]
impl crate::ResetValue for super::TXMAXP1 {
    type Type = u16;
    #[inline(always)]
