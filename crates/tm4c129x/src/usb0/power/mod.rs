...
impl R {
    ...
    #[inline]
    pub fn pwrdnphy(&self) -> PWRDNPHYR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 0;
...
impl W {
    ...
    #[doc = "Bit 0 - Power Down PHY"]
    #[inline]
    pub fn pwrdnphy(&mut self) -> _PWRDNPHYW {
        _PWRDNPHYW { w: self }
    }
    #[doc = "Bit 1 - SUSPEND Mode"]
    #[inline]
    ...
    #[doc = "Bit 5 - High Speed Enable"]
    #[inline]
    pub fn hsenab(&mut self) -> _HSENABW {
        _HSENABW { w: self }
    }
    #[doc = "Bit 6 - Soft Connect/Disconnect"]
    #[inline]
    pub fn softconn(&mut self) -> _SOFTCONNW {
        _SOFTCONNW { w: self }
    }
    #[doc = "Bit 7 - Isochronous Update"]
    #[inline]
    pub fn isoup(&mut self) -> _ISOUPW {
        _ISOUPW { w: self }
    }
}
