#[doc = "Reader of register TXTYPE3"]
pub type R = crate::R<u8, super::TXTYPE3>;
#[doc = "Writer for register TXTYPE3"]
pub type W = crate::W<u8, super::TXTYPE3>;
#[doc = "Register TXTYPE3 `reset()`'s with value 0"]
impl crate::ResetValue for super::TXTYPE3 {
    type Type = u8;
    #[inline(always)]
