#[doc = "Reader of register TXCSRL1"]
pub type R = crate::R<u8, super::TXCSRL1>;
#[doc = "Writer for register TXCSRL1"]
pub type W = crate::W<u8, super::TXCSRL1>;
#[doc = "Register TXCSRL1 `reset()`'s with value 0"]
impl crate::ResetValue for super::TXCSRL1 {
    type Type = u8;
    #[inline(always)]
