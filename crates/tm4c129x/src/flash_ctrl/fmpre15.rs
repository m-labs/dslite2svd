#[doc = "Reader of register FMPRE15"]
pub type R = crate::R<u32, super::FMPRE15>;
#[doc = "Writer for register FMPRE15"]
pub type W = crate::W<u32, super::FMPRE15>;
#[doc = "Register FMPRE15 `reset()`'s with value 0"]
impl crate::ResetValue for super::FMPRE15 {
    type Type = u32;
    #[inline(always)]
