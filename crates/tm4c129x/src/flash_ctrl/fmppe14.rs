#[doc = "Reader of register FMPPE14"]
pub type R = crate::R<u32, super::FMPPE14>;
#[doc = "Writer for register FMPPE14"]
pub type W = crate::W<u32, super::FMPPE14>;
#[doc = "Register FMPPE14 `reset()`'s with value 0"]
impl crate::ResetValue for super::FMPPE14 {
    type Type = u32;
    #[inline(always)]
