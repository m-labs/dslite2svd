#[doc = "Reader of register FMPPE11"]
pub type R = crate::R<u32, super::FMPPE11>;
#[doc = "Writer for register FMPPE11"]
pub type W = crate::W<u32, super::FMPPE11>;
#[doc = "Register FMPPE11 `reset()`'s with value 0"]
impl crate::ResetValue for super::FMPPE11 {
    type Type = u32;
    #[inline(always)]
