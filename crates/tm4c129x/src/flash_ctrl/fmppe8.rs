#[doc = "Reader of register FMPPE8"]
pub type R = crate::R<u32, super::FMPPE8>;
#[doc = "Writer for register FMPPE8"]
pub type W = crate::W<u32, super::FMPPE8>;
#[doc = "Register FMPPE8 `reset()`'s with value 0"]
impl crate::ResetValue for super::FMPPE8 {
    type Type = u32;
    #[inline(always)]
