#[doc = "Reader of register FMPPE10"]
pub type R = crate::R<u32, super::FMPPE10>;
#[doc = "Writer for register FMPPE10"]
pub type W = crate::W<u32, super::FMPPE10>;
#[doc = "Register FMPPE10 `reset()`'s with value 0"]
impl crate::ResetValue for super::FMPPE10 {
    type Type = u32;
    #[inline(always)]
