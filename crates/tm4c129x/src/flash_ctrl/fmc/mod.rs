...
impl W {
    ...
    #[doc = "Bit 2 - Mass Erase Flash Memory"]
    #[inline]
    pub fn merase(&mut self) -> _MERASEW {
        _MERASEW { w: self }
    }
    #[doc = "Bit 3 - Commit Register Value"]
    #[inline]
    pub fn comt(&mut self) -> _COMTW {
        _COMTW { w: self }
    }
    #[doc = "Bits 17:31 - FLASH write key"]
    #[inline]
    pub fn wrkey(&mut self) -> _WRKEYW {
        _WRKEYW { w: self }
    }
}
