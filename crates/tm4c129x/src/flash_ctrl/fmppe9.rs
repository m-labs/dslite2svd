#[doc = "Reader of register FMPPE9"]
pub type R = crate::R<u32, super::FMPPE9>;
#[doc = "Writer for register FMPPE9"]
pub type W = crate::W<u32, super::FMPPE9>;
#[doc = "Register FMPPE9 `reset()`'s with value 0"]
impl crate::ResetValue for super::FMPPE9 {
    type Type = u32;
    #[inline(always)]
