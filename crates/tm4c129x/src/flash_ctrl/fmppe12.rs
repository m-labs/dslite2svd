#[doc = "Reader of register FMPPE12"]
pub type R = crate::R<u32, super::FMPPE12>;
#[doc = "Writer for register FMPPE12"]
pub type W = crate::W<u32, super::FMPPE12>;
#[doc = "Register FMPPE12 `reset()`'s with value 0"]
impl crate::ResetValue for super::FMPPE12 {
    type Type = u32;
    #[inline(always)]
