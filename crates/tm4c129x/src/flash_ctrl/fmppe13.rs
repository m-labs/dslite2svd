#[doc = "Reader of register FMPPE13"]
pub type R = crate::R<u32, super::FMPPE13>;
#[doc = "Writer for register FMPPE13"]
pub type W = crate::W<u32, super::FMPPE13>;
#[doc = "Register FMPPE13 `reset()`'s with value 0"]
impl crate::ResetValue for super::FMPPE13 {
    type Type = u32;
    #[inline(always)]
