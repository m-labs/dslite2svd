#[doc = "Reader of register FMPRE10"]
pub type R = crate::R<u32, super::FMPRE10>;
#[doc = "Writer for register FMPRE10"]
pub type W = crate::W<u32, super::FMPRE10>;
#[doc = "Register FMPRE10 `reset()`'s with value 0"]
impl crate::ResetValue for super::FMPRE10 {
    type Type = u32;
    #[inline(always)]
