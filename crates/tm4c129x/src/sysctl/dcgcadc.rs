#[doc = "Reader of register DCGCADC"]
pub type R = crate::R<u32, super::DCGCADC>;
#[doc = "Writer for register DCGCADC"]
pub type W = crate::W<u32, super::DCGCADC>;
#[doc = "Register DCGCADC `reset()`'s with value 0"]
impl crate::ResetValue for super::DCGCADC {
    type Type = u32;
    #[inline(always)]
