...
impl W {
    ...
    #[doc = "Bit 1 - MOSC Failure Action"]
    #[inline]
    pub fn moscim(&mut self) -> _MOSCIMW {
        _MOSCIMW { w: self }
    }
    #[doc = "Bit 2 - No Crystal Connected"]
    #[inline]
    pub fn noxtal(&mut self) -> _NOXTALW {
        _NOXTALW { w: self }
    }
    #[doc = "Bit 3 - Power Down"]
    #[inline]
    ...
    #[doc = "Bit 4 - Oscillator Range"]
    #[inline]
    pub fn oscrng(&mut self) -> _OSCRNGW {
        _OSCRNGW { w: self }
    }
}
