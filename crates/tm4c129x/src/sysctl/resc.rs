...
#[doc = "Reader of field `HSSR`"]
pub type HSSR_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `HSSR`"]
pub struct HSSR_W<'a> {
    w: &'a mut W,
}
impl<'a> HSSR_W<'a> {
...
impl R {
    ...
    #[inline(always)]
    pub fn hssr(&self) -> HSSR_R {
        HSSR_R::new(((self.bits >> 12) & 0x01) != 0)
    }
