#[doc = "Reader of register PCI2C"]
pub type R = crate::R<u32, super::PCI2C>;
#[doc = "Writer for register PCI2C"]
pub type W = crate::W<u32, super::PCI2C>;
#[doc = "Register PCI2C `reset()`'s with value 0"]
impl crate::ResetValue for super::PCI2C {
    type Type = u32;
    #[inline(always)]
