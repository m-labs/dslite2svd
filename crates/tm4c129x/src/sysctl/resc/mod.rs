...
impl R {
    ...
    #[inline]
    pub fn moscfail(&self) -> MOSCFAILR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 16;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 5 - Watchdog Timer 1 Reset"]
    #[inline]
    pub fn wdt1(&mut self) -> _WDT1W {
        _WDT1W { w: self }
    }
    #[doc = "Bit 12 - HSSR Reset"]
    #[inline]
    pub fn hssr(&mut self) -> _HSSRW {
        _HSSRW { w: self }
    }
    #[doc = "Bit 16 - MOSC Failure Reset"]
    #[inline]
    pub fn moscfail(&mut self) -> _MOSCFAILW {
        _MOSCFAILW { w: self }
    }
}
