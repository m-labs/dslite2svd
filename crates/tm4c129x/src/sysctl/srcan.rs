#[doc = "Reader of register SRCAN"]
pub type R = crate::R<u32, super::SRCAN>;
#[doc = "Writer for register SRCAN"]
pub type W = crate::W<u32, super::SRCAN>;
#[doc = "Register SRCAN `reset()`'s with value 0"]
impl crate::ResetValue for super::SRCAN {
    type Type = u32;
    #[inline(always)]
