...
#[doc(hidden)]
pub struct _ACSTAT2;
#[doc = "`read()` method returns [acstat2::R](acstat2::R) reader structure"]
...
#[doc(hidden)]
pub struct _ACCTL2;
#[doc = "`read()` method returns [acctl2::R](acctl2::R) reader structure"]
impl crate::Readable for ACCTL2 {}
#[doc = "`write(|w| ..)` method takes [acctl2::W](acctl2::W) writer structure"]
