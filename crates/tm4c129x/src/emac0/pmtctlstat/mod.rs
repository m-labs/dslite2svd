...
impl R {
    ...
    #[inline]
    pub fn wupfrrst(&self) -> WUPFRRSTR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 31;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 2 - Wake-Up Frame Enable"]
    #[inline]
    pub fn wupfren(&mut self) -> _WUPFRENW {
        _WUPFRENW { w: self }
    }
    #[doc = "Bit 5 - Magic Packet Received"]
    #[inline]
    pub fn mgkprx(&mut self) -> _MGKPRXW {
        _MGKPRXW { w: self }
    }
    #[doc = "Bit 6 - Wake-Up Frame Received"]
    #[inline]
    pub fn wuprx(&mut self) -> _WUPRXW {
        _WUPRXW { w: self }
    }
    #[doc = "Bit 9 - Global Unicast"]
    #[inline]
    ...
    #[doc = "Bit 31 - Wake-Up Frame Filter Register Pointer Reset"]
    #[inline]
    pub fn wupfrrst(&mut self) -> _WUPFRRSTW {
        _WUPFRRSTW { w: self }
    }
}
