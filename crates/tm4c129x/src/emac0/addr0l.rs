#[doc = "Reader of register ADDR0L"]
pub type R = crate::R<u32, super::ADDR0L>;
#[doc = "Writer for register ADDR0L"]
pub type W = crate::W<u32, super::ADDR0L>;
#[doc = "Register ADDR0L `reset()`'s with value 0"]
impl crate::ResetValue for super::ADDR0L {
    type Type = u32;
    #[inline(always)]
