#[doc = "Reader of register ADDR1L"]
pub type R = crate::R<u32, super::ADDR1L>;
#[doc = "Writer for register ADDR1L"]
pub type W = crate::W<u32, super::ADDR1L>;
#[doc = "Register ADDR1L `reset()`'s with value 0"]
impl crate::ResetValue for super::ADDR1L {
    type Type = u32;
    #[inline(always)]
