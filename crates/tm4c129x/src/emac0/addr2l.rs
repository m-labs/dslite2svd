#[doc = "Reader of register ADDR2L"]
pub type R = crate::R<u32, super::ADDR2L>;
#[doc = "Writer for register ADDR2L"]
pub type W = crate::W<u32, super::ADDR2L>;
#[doc = "Register ADDR2L `reset()`'s with value 0"]
impl crate::ResetValue for super::ADDR2L {
    type Type = u32;
    #[inline(always)]
