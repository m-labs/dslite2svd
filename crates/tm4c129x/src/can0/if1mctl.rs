#[doc = "Reader of register IF1MCTL"]
pub type R = crate::R<u32, super::IF1MCTL>;
#[doc = "Writer for register IF1MCTL"]
pub type W = crate::W<u32, super::IF1MCTL>;
#[doc = "Register IF1MCTL `reset()`'s with value 0"]
impl crate::ResetValue for super::IF1MCTL {
    type Type = u32;
    #[inline(always)]
