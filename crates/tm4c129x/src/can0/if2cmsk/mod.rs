...
impl W {
    ...
    #[doc = "Bit 0 - Access Data Byte 4 to 7"]
    #[inline]
    pub fn datab(&mut self) -> _DATABW {
        _DATABW { w: self }
    }
    #[doc = "Bit 1 - Access Data Byte 0 to 3"]
    #[inline]
    pub fn dataa(&mut self) -> _DATAAW {
        _DATAAW { w: self }
    }
    #[doc = "Bit 2 - Access New Data"]
    #[inline]
