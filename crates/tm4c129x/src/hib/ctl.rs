...
pub type OSCSEL_R = crate::R<bool, bool>;
...
#[doc = "Reader of field `RETCLR`"]
pub type RETCLR_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `RETCLR`"]
pub struct RETCLR_W<'a> {
    w: &'a mut W,
}
impl<'a> RETCLR_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl R {
    ...
    pub fn oscsel(&self) -> OSCSEL_R {
        OSCSEL_R::new(((self.bits >> 19) & 0x01) != 0)
    }
    #[doc = "Bit 30 - GPIO Retention/Clear"]
    #[inline(always)]
    pub fn retclr(&self) -> RETCLR_R {
        RETCLR_R::new(((self.bits >> 30) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 30 - GPIO Retention/Clear"]
    #[inline(always)]
    pub fn retclr(&mut self) -> RETCLR_W {
        RETCLR_W { w: self }
    }
    #[doc = "Bit 31 - Write Complete/Capable"]
    #[inline(always)]
